...
import { appVersion , APP_INFO} from '../constants/constants';
        ...
        <View style={[styles.container, { backgroundColor: theme.background }]}>
            ...
            <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.appInfoSection}>
                    ...
                    />
                    <Text style={[styles.appName, { color: theme.textColor }]}>{APP_INFO.NAME}</Text>
                ...
                <View >
                    ...
                    <View style={[styles.developerInfo, { backgroundColor: theme.secondaryBackground }]}>
                        <Image
                            source={{ uri: APP_INFO.DEVELOPER_IMG }}
